...
namespace CarShineServices.wsMainService {
    using System;
    ...
    public partial class MainService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public MainService() {
            this.Url = global::CarShineServices.Properties.Settings.Default.CarShineServices_wsMainService_MainService;
        ...
        public System.Data.DataSet GetDataSet(string Query, string Params, string token, string userName) {
        ...
        /// <remarks/>
        public void GetDataSetAsync(string Query, string Params, string token, string userName) {
            this.GetDataSetAsync(Query, Params, token, userName, null);
        }
        
        /// <remarks/>
        public void GetDataSetAsync(string Query, string Params, string token, string userName, object userState) {
            ...
            this.InvokeAsync("GetDataSet", new object[] {
                        ...
                        Params,
                        token,
                        userName}, this.GetDataSetOperationCompleted, userState);
        }
